...
CREATE DATABASE IF NOT EXISTS analytics_02;
CREATE TABLE IF NOT EXISTS analytics_02.events
(
    utm_valid               UInt8,
    utm_source              String,
	utm_medium              String,
...
ENGINE = ReplicatedMergeTree('/clickhouse/tables/tc_shard_02/events', 'replica_02')
