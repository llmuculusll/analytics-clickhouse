...
CREATE DATABASE IF NOT EXISTS analytics_03;
CREATE TABLE IF NOT EXISTS analytics_03.events
(
    utm_valid               UInt8,
    utm_source              String,
	utm_medium              String,
...
ENGINE = ReplicatedMergeTree('/clickhouse/tables/tc_shard_03/events', 'replica_01')
